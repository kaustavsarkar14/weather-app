...
function App() {
  ...
  useEffect(()=>{
    ...
    if(loading) return (<img style={{margin:"auto", display:"block", marginTop:"5rem", width:"100vw"}} src='https://i.pinimg.com/originals/53/32/38/533238dd9a8ebfeaf7a8f4d4c2cabab6.gif' />)
